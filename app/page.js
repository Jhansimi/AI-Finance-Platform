  ...
  return (
    ...
    <section className='py-20'>
      <div className='container mx-auto px-4'>
        ...
        <CardContent className="pt-4"> 
          <div className='flex items-cener mb-4'>
            <Image src={testimonal.image} alt={testimonal.name} width={40} height={40}
            className="rounded-full"/>

            <div className='ml-4'>
              <div className='font-semibold'>{testimonal.name}</div>
              <div className='text-sm text-gray-600'>{testimonal.role}</div>
            </div>
          </div>
    ...
    <section className='py-20 bg-blue-600'>
      <div className='container mx-auto px-4 text-center'>
        ...
        <p className='text-blue-100 mb-8 max-w-2xl mx-auto'>Join thousands of users who are alredy managing their finances 
          smarter with welth
        </p>
        <Link href="/dashboard">
